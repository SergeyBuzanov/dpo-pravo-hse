...
(function () {
  ...
  var CSS = [
    ...
    'background:rgba(33,30,27,.55);opacity:0;transition:opacity .22s cubic-bezier(.22,1,.36,1)}',
    '.dpo-app-backdrop.is-open{opacity:1}',
    '.dpo-app{position:relative;width:100%;max-width:560px;background:#FBF9F5;color:#211E1B;',
    'border-radius:18px;box-shadow:0 24px 60px rgba(33,30,27,.28);padding:clamp(22px,4vw,34px);',
    ...
    '.dpo-app-program{font-size:14px;line-height:1.5;color:#6B6459;margin:0 0 20px}',
    '.dpo-app-close{position:absolute;top:14px;right:14px;width:38px;height:38px;border-radius:50%;',
    'border:1px solid rgba(33,30,27,.12);background:#fff;color:#211E1B;font-size:20px;line-height:1;',
    'cursor:pointer;transition:background .15s,border-color .15s}',
    '.dpo-app-close:hover{background:#F2ECE1}',
    ...
    '.dpo-app-check input{margin:2px 0 0;width:17px;height:17px;accent-color:#1658DA;flex:none}',
    '.dpo-app-consent{display:flex;gap:10px;align-items:flex-start;font-size:13px;line-height:1.5;',
    'color:#48423A;margin:6px 0 4px;cursor:pointer}',
    '.dpo-app-consent a{color:#1658DA}',
    '.dpo-app-submit{margin-top:18px;width:100%;font:inherit;font-size:15px;font-weight:600;color:#fff;',
    'background:#1658DA;border:0;border-radius:999px;padding:14px 20px;cursor:pointer;',
    ...
    '.dpo-app-note{font-size:12px;line-height:1.5;color:#6B6459;margin:12px 0 0;text-align:center}',
    ...
    '.dpo-app-done p{font-size:15px;line-height:1.6;color:#48423A;margin:0 0 8px}',
