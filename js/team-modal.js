...
(function () {
  ...
  var CSS = [
    ...
    '.dpo-team-about{font-size:15px;line-height:1.6;color:var(--ink-soft);margin:0 0 18px}',
    ...
    '.dpo-team-hse{display:inline-block;margin-top:14px;font-size:14.5px;font-weight:600;color:rgb(var(--accent));',
