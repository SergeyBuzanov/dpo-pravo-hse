...
(function () {
  ...
  var CSS = [
    ...
    '.dpo-team{position:relative;width:100%;max-width:560px;background:#FBF9F5;color:#211E1B;',
    ...
    '.dpo-team-close:hover{background:#F2ECE1}',
    '.dpo-team-about{font-size:15px;line-height:1.6;color:#48423A;margin:0 0 18px}',
    '.dpo-team-label{font-size:13px;font-weight:600;letter-spacing:.12em;text-transform:uppercase;',
    'color:#1658DA;margin:0 0 8px}',
    '.dpo-team-programs{list-style:none;margin:0 0 6px;padding:0}',
    '.dpo-team-programs li{border-top:1px solid rgba(33,30,27,.1)}',
    '.dpo-team-programs a{display:block;padding:10px 2px;font-size:14.5px;line-height:1.45;',
    'color:#1658DA;text-decoration:underline;text-decoration-color:rgba(22,88,218,.35);',
    'text-underline-offset:3px}',
    '.dpo-team-programs a:hover{text-decoration-color:currentColor}',
    '.dpo-team-hse{display:inline-block;margin-top:14px;font-size:14.5px;font-weight:600;color:#1658DA;',
