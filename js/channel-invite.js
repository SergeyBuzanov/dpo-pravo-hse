 ...
 *
 * Правила показа (указание заказчика, август 2026; 18.08 изменено):
 *  - окно появляется сразу при заходе на сайт (с секундной паузой после
 *    отрисовки; прежнее правило «после ответа на баннер cookies» снято
 *    указанием заказчика 18.08.2026 – окно и баннер не перекрываются:
 *    карточка в правом нижнем углу, баннер по центру низа);
...
(function () {
  ...
  // Окно показывается сразу при заходе на сайт (новое указание заказчика,
  // 18.08.2026 – прежнее правило «после ответа на баннер cookies» снято).
  // Секундная пауза – чтобы карточка не выпрыгивала до отрисовки страницы;
  // баннеру cookies окно не мешает: оно в правом нижнем углу, баннер по
  // центру низа. Закрытие по-прежнему запоминается на месяц.
