...
(function () {
  ...
  var CSS = [
    ...
    '.dpo-quiz-sub{font-size:15px;line-height:1.55;color:#48423A;margin:0 0 18px}',
    ...
    '.dpo-quiz-opt span{display:inline-block;font:inherit;font-size:15px;line-height:1.3;',
    ...
    '.dpo-quiz-submit{display:inline-block;font:inherit;font-size:15px;font-weight:600;color:rgb(var(--surface));',
