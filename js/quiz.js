...
(function () {
  ...
  var CSS = [
    ...
    '.dpo-quiz{position:relative;width:100%;max-width:560px;background:#FBF9F5;color:#211E1B;',
    ...
    '.dpo-quiz-opt span{display:inline-block;font:inherit;font-size:14px;line-height:1.3;',
    'padding:9px 16px;border-radius:999px;border:1px solid rgba(33,30,27,.22);background:#fff;',
    'transition:border-color .15s,background .15s,color .15s}',
    '.dpo-quiz-opt input:checked+span{background:#1658DA;border-color:#1658DA;color:#fff}',
    '.dpo-quiz-opt input:focus-visible+span{outline:2px solid #1658DA;outline-offset:2px}',
    '.dpo-quiz-submit{display:inline-block;font:inherit;font-size:15px;font-weight:600;color:#fff;',
    'background:#1658DA;border:0;border-radius:999px;padding:14px 28px;cursor:pointer;',
    ...
    'border-radius:50%;background:#F2ECE1;color:#211E1B;font-size:18px;line-height:36px;',
