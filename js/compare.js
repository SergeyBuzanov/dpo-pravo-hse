...
(function () {
  ...
  var ROWS = [
    ...
    // Модули: сперва их число одним взглядом, ниже – сами названия
    // (владелец 05.09.2026: «как можно сравнивать без модулей»). Оба
    // берутся из одного атрибута: второй источник тех же данных на
    // странице разошёлся бы с первым при первом же обновлении каталога.
