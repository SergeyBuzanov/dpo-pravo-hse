...
- [ ] **A1. Сверить контактные данные с факультетом.** Координатор клуба («Иванова Анна Сергеевна»), добавочные номера 22112 и 22113, канал `t.me/pravo_alumni`. Публикация имени и прямого номера конкретного сотрудника без подтверждения — репутационный риск.
