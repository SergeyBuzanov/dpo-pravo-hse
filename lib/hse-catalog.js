...
/**
 * Дата для микроразметки — по ЛОКАЛЬНЫМ компонентам, не через toISOString():
 * старт «20 июля 00:00» по Москве в UTC это ещё 19 июля, и Schema.org получал
 * дату на сутки раньше настоящей.
 */
