...
async function deliver(application, opts = {}) {
  ...
  const letter = {
    ...
    subject: `Заявка ДПО: ${displayName(application)} — ${application.program.title || 'без программы'}`,
...
module.exports = { deliver, formatLetter, mailConfig, SOURCE_LABELS, SOURCES };
