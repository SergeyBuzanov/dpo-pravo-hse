...
// оригиналами. Фон – bg-blue-720.png: фирменный синий #102D69 с белой
// надписью эмблемы ВШЭ (вариант «синий по брендбуку», выбор заказчика;
// пергаментный bg-720.png оставлен рядом на случай возврата).
//
